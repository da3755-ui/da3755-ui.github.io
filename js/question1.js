...
class Question1{
    constructor(question, option1, option2){
        ...
        this.option1Button.position(width/30, height/1.5);
        ...
        this.option2Button.position(width/1.83, height/1.5);
    ...
    updatePosition(){
  this.option1Button.position(width*0.5, height*0.7);
  this.option2Button.position(width*0.5, height*0.7);
    }
